...
// norm of Quaternion
const MyQuaternion MyQuaternion::norm() const{
    double Q_betrag_sqrt;
    Q_betrag_sqrt=sqrt(this->Quaternion[0]*this->Quaternion[0]
    ...
    for (auto i=0; i<4; i++)
    {
        result.Quaternion[i]=this->Quaternion[i]/Q_betrag_sqrt;
    }
...
// norm of Quaternion
double MyQuaternion::betrag() const{
